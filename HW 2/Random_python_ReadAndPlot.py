...
#Dr. Rogan's code left in for use
"""class Random:
...
if __name__ == "__main__":
    ...
    #read in the data from the previously writen randomNums.txt file
    myx = []
    
    with open("randomNums.txt") as file:
    ...
    """
    #Writing the random number array to a .txt file
